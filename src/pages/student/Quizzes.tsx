          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 text-center md:text-left">
              ...
              <div>
                ...
                <h1 className="font-display text-2xl md:text-4xl font-bold text-slate-900">Quiz Center</h1>
                <p className="mt-2 text-sm md:text-base text-slate-500 font-medium max-w-xl">
                  Measure your curriculum mastery. Institutional assessments provide real-time feedback on your academic trajectory.
                </p>
              </div>
            </div>
            <Button 
              className="bg-slate-950 hover:bg-sky-600 text-white font-black h-14 md:h-16 px-8 md:px-10 rounded-xl md:rounded-2xl shadow-xl shadow-sky-200 transition-all hover:scale-105 active:scale-95 text-base md:text-lg w-full lg:w-auto"
              onClick={() => {
            ...
            >
              <Sparkles className="mr-3 h-5 w-5 md:h-6 md:w-6" /> Start Priority Quiz
            </Button>
          </div>
        </section>
