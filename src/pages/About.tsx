...
const values = [
  { icon: Target, title: "Mission-Driven", description: "Quality education must be accessible to every person on Earth, regardless of geography or economic circumstances.", color: "from-primary to-emerald-400" },
  { icon: Heart, title: "Student-First Design", description: "Every feature, from progress tracking to certificate generation, is designed around the learner's journey.", color: "from-accent to-amber-400" },
  { icon: Globe, title: "Global Reach", description: "Built to serve learners and educators worldwide, meeting both US and international education standards.", color: "from-emerald-500 to-teal-400" },
  { icon: GraduationCap, title: "Academic Excellence", description: "Our assessment system - exercises, quizzes, tests, examinations - is built for rigorous academic programs.", color: "from-primary to-accent" },
];

const team = [
  { initials: "MC", name: "Michael Chen", role: "Co-founder and CEO", bg: "from-primary to-emerald-400" },
  { initials: "SK", name: "Sarah Kim", role: "Head of Education", bg: "from-accent to-amber-400" },
  { initials: "JM", name: "James Miller", role: "CTO", bg: "from-primary to-accent" },
  { initials: "AR", name: "Aisha Rahman", role: "Head of Design", bg: "from-emerald-500 to-teal-400" },
];
    ...
    <main>
      <section className="relative overflow-hidden pt-36 pb-24">
        ...
        <div className="container relative mx-auto px-4 text-center">
          ...
          >
            {[{ val: "68K+", lbl: "Active Users" }, { val: "3.4K+", lbl: "Courses Published" }, { val: "180+", lbl: "Institutions" }].map((s) => (
          ...
          <div className="mx-auto grid max-w-5xl items-center gap-16 lg:grid-cols-2">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <p className="mt-4 text-muted-foreground leading-relaxed">
                We believe that the quality of your education should not depend on the budget of your school district. Learnflow AI provides institutions and self-learners with the same enterprise-grade tools used by leading universities, completely free.
              </p>
              <p className="mt-4 text-muted-foreground leading-relaxed">
                From AI-assisted course creation to automated certificate generation, we build the features educators actually need, not the features that look good in a sales deck.
              </p>
            </motion.div>
            ...
            >
              {[
                { icon: Users, val: "68K+", label: "Students Learning", color: "text-primary bg-primary/10" },
                { icon: BookOpen, val: "3.4K", label: "Active Courses", color: "text-accent bg-accent/10" },
                { icon: Award, val: "120K+", label: "Certificates Issued", color: "text-emerald-600 bg-emerald-500/10" },
                { icon: GraduationCap, val: "100%", label: "Always Free", color: "text-emerald-500 bg-emerald-500/10" },
              ].map((s) => (
